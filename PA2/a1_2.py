...
def display():
    global cameraIndex, cow2wld, clickNum, animStartTime, cowPosition, prevCow
...
def onMouseButton(window, button, state, mods):
    global isDrag, V_DRAG, H_DRAG, clickNum, animStartTime, cowPosition
    GLFW_DOWN = 1;
    GLFW_UP = 0;
...
def onMouseDrag(window, x, y):
    global isDrag, cursorOnCowBoundingBox, pickInfo, cow2wld, clickNum
    if isDrag:
